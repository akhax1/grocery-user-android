package com.kkgrocery.user.web;


import com.kkgrocery.user.R;
import com.kkgrocery.user.MainActivity;
import com.kkgrocery.user.ErrorDialogFragment;
...
public class WebFragment extends Fragment implements MainActivity.Listener, AdvancedWebView.Listener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // --- STATUS BAR COLOR BRIDGE START ---
        webView.getSettings().setJavaScriptEnabled(true); // Isse JS chalu ho jayega
        webView.addJavascriptInterface(new Object() {
            @android.webkit.JavascriptInterface
            public void changeStatusBarColor(final String colorCode) {
                if (getActivity() != null) {
                        ...
                        public void run() {
                            try {
                                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                                    ...
                                    getActivity().getWindow().setStatusBarColor(android.graphics.Color.parseColor(colorCode));

                                    // Light color ke liye icons black karne ke liye
                                    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                                        getActivity().getWindow().getDecorView().setSystemUiVisibility(android.view.View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR);
                                    }
                                }
                            } catch (Exception e) {
                                e.printStackTrace();
